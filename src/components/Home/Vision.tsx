...
export default function Vision() {
  ...
  useEffect(() => {
    ...
    fetch(
      `${AdminPanelUrl}/home-page?populate[vision_mission_section][populate]=*`,
      requestOptions
    )
      ...
      .then((result) => {
        if (result?.data?.vision_mission_section) {
          ...
          const newData = data.map((v: any) => {
            const baseurl = AdminPanelImgUrl;
            return {
              ...v,
                  ...
                  >
                    <>
                      <div className="w-full md:max-w-2xl md:ml-4 space-y-16 desktop-1500:space-y-14 desktop-1200:space-y-12 desktop-1900:space-y-16 desktop-1900:pl-10">
                        ...
                        <p
                          className="text-sm md:text-[20px] desktop-1500:text-[17px] leading-7 desktop-1500:leading-6 text-[#808080] mb-6 md:mb-8  max-w-[90%] desktop-1500:max-w-[80%] 
                   desktop-1200:max-w-[80%] desktop-1200:text-[14px] desktop-1200:leading-5 desktop-1900:text-[1.45rem] desktop-1900:max-w-[100%] desktop-1900:leading-7"
                        ...
                        <div className="flex gap-3 md:gap-4">
                          ...
                          >
                            Donate{" "}
                            <Heart
                              className="h-4 w-4 md:h-5 md:w-5 desktop-1200:w-4 desktop-1200:h-4 desktop-1900:w-5 desktop-1900:h-5"
                              fill="white"
                            />
                          </Link>
                        </div>
