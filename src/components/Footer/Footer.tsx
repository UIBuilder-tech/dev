        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-1">
                ...
                <li><a href="#" className="hover:underline">Samvit Sudha</a></li>
                <li><a href="#" className="hover:underline">Parimochan Project</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1">
              ...
              <li><a href="#" className="hover:underline">How You can Help</a></li>
              <li><a href="#" className="hover:underline">CHF Events & News</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1">
              ...
              <li><a href="#" className="hover:underline">Religious Activities</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-1">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+12156663200" className="hover:underline">(215) 666-3200</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail size={16} className="flex-shrink-0" />
                <a href="mailto:contactus@chfusa.org" className="hover:underline">contactus@chfusa.org</a>
              </li>
