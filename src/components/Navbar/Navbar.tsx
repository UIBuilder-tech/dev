...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`fixed w-full z-40 bg-gradient-to-b from-black/50 to-transparent ${
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-10">
              ...
              <div className="bg-white backdrop-blur-sm rounded-full pl-4 flex items-center gap-4">
                <a href="/"><img src={HomeIcon} className='w-6 h-6 text-white'/></a>
                <button onClick={() => setIsModalOpen(true)}>
                  <img src={ProfileIcon} className='w-6 h-6' />
                </button>
                <a><img src={ContactIcon} className='w-6 h-6 cursor-pointer' onClick={(e)=>{
                  e.preventDefault();
