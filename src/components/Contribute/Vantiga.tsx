...
export default function Vantiga({
  ...
  description = "Vantiga refers to monetary contributions made by the Chitrapur Saraswat community members to support the Chitrapur Math and its various initiatives. This practice is an important aspect of community engagement and support, as it enables the Math to sustain its activities, including spiritual programs, cultural preservation, hospitality services and community welfare efforts. Vantiga reflects the commitment of community members to their spiritual heritage and their role in contributing to the ongoing work of the Math in serving the needs of the Chitrapur Saraswat community. It is suggested that every member contributes Vantiga equivalent to 1% of their income. Alternatively, a minimum amount of $1.50 per day per family ($500 annually) is proposed as a possible contribution.",
}: Props) {
      ...
      <div className="container absolute z-[10] -top-[50px] md:-top-[150px] right-0 left-0 mx-auto bg-white rounded-[30px] md:rounded-[50px] p-2 md:p-10 max-w-[90%] md:max-w-[75%] desktop-1200:p-6 desktop-1500:p-10 desktop-1900:p-12 desktop-1200:max-w-[80%]">
        <div className=" z-[9999] relative flex flex-row justify-around md:gap-6 item-center text-center w-full desktop-1900:gap-[100px]">
          ...
          <div className="flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4">
            ...
            <p className="text-start max-sm:text-xs desktop-1200:text-sm desktop-1900:text-lg">
              Join CHF and lend your skills to uplift communities and support
              impactful initiatives globally.
            </p>
          </div>
          <div className="flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4">
            <img
            ...
            <p className="text-start max-sm:text-xs desktop-1200:text-sm desktop-1900:text-lg">
              Be part of something meaningful. Engage with CHF’s initiatives and
              play an active role in driving community development and cultural
              preservation.
            </p>
          </div>
        </div>
