  ...
  return (
    <section id="vantiga" className="relative bg-[#E67E22] py-16">
        ...
        <div className="flex flex-row justify-around md:gap-6 item-center text-center w-full">
            ...
            <p className='md:text-2xl text-sm text-[#02306A] font-bold'>Donate</p>
            <p className='text-start max-sm:text-xs'>Contribute to various causes adopted by CHF. Your donation helps CHF support various causes globally.</p>
            </div>
            <div className='flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4'>
                <img src={volunteer} className='w-8 h-8 md:w-14 md:h-14'/>
            <p className='md:text-2xl text-sm text-[#02306A] font-bold'>Volunteer</p>
            <p className='text-start max-sm:text-xs'>Contribute to various causes adopted by CHF. Your donation helps CHF support various causes globally.</p>
            </div>
            <div className='flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4'>
                <img src={involved} className='w-8 h-8 md:w-14 md:h-14'/>
            <p className='md:text-2xl text-sm text-[#02306A] font-bold'>Get Involved</p>
            <p className='text-start max-sm:text-xs'>Contribute to various causes adopted by CHF. Your donation helps CHF support various causes globally.</p>
            </div>
        </div>
        </div>
      ...
      <div className="flex flex-col justify-center item-center text-center space-y-10 w-full">
              <h2 className="text-3xl md:text-5xl text-white">What is Vantiga?</h2>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <div className="h-8 w-full bg-[url('../../assets/section-border.svg')] bg-repeat-x" ><img src={sectionBorder} className='w-full h-full'/></div>
      </div>
    </section>
  )
}
