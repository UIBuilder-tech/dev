    ...
    <section className="relative bg-[#E67E22] py-16 desktop-1900:mb-10">
        ...
        <div className=" z-[9999] relative flex flex-row justify-around md:gap-6 item-center text-center w-full desktop-1900:gap-[100px]">
          <div className="flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4">
            <img src={donate} className="w-8 h-8 md:w-14 md:h-14 desktop-1900:w-16  desktop-1900:h-16" />
          ...
          <div className="flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4">
            <img src={volunteer} className="w-8 h-8 md:w-14 md:h-14 desktop-1900:w-16  desktop-1900:h-16" />
            <p className="md:text-2xl text-sm text-[#02306A] font-bold  desktop-1200:text-xl desktop-1900:text-2xl">
              Volunteer
            </p>
            <p className="text-start max-sm:text-xs desktop-1200:text-sm desktop-1900:text-lg">
          ...
          <div className="flex flex-col space-y-2 md:space-y-4 items-start p-2 md:p-4">
            <img src={involved} className="w-8 h-8 md:w-14 md:h-14 desktop-1900:w-16  desktop-1900:h-16" />
            <p className="md:text-2xl text-sm text-[#02306A] font-bold  desktop-1200:text-xl desktop-1900:text-2xl">
              Get Involved
            </p>
            <p className="text-start max-sm:text-xs desktop-1200:text-sm desktop-1900:text-lg">
      ...
      <div className="container relative z-[10] mx-auto px-4 w-full py-14 md:py-20 desktop-1200:py-10 desktop-1500:py-16 mt-12 desktop-1900:mt-28">
        <div className="flex flex-col justify-center item-center text-center space-y-10 w-full">
          <h2 className="text-3xl md:text-5xl text-white desktop-1500:text-4xl desktop-1200:text-3xl desktop-1900:text-5xl">{title}</h2>
     ...
     {(location?.pathname?.includes('/contribute') || location?.pathname?.includes('/project')) && <div className="absolute bottom-0 left-0 right-0">
