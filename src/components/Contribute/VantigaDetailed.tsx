...
export default function VantigaDetailed() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 desktop-1200:py-12 desktop-1500:py-14 desktop-1900:py-16">
      ...
      <p className="text-center text-sm sm:text-base text-gray-600 mb-8 sm:mb-12 max-w-4xl mx-auto desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl desktop-1200:max-w-5xl desktop-1500:max-w-6xl desktop-1900:max-w-7xl desktop-1200:mb-12 desktop-1500:mb-14 desktop-1900:mb-16">
        Vantigā refers to the annual contributions made by the Chitrapur
      ...
      <div className="relative">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 desktop-1200:gap-8 desktop-1500:gap-10 desktop-1900:gap-12">
            ...
            <div className="space-y-6 desktop-1200:space-y-6 desktop-1500:space-y-8 desktop-1900:space-y-10">
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                <img
                  src={grantsIcon}
                  alt="grantsIcon"
                  className="w-5 h-5 text-[#E67E22] flex-shrink-0 mt-1 desktop-1200:w-5 desktop-1200:h-5 desktop-1500:w-6 desktop-1500:h-6 desktop-1900:w-7 desktop-1900:h-7"
                />
                <p className="text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
                  Vantigā refers to the annual contributions made by the
                  ...
                  services, and community welfare efforts. Vantigā reflects the
              ...
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                ...
                <p className="text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
                  ...
                  It's suggested that every member contributes Vantigā
              ...
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                ...
                <p className="text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
                  ...
                  Contributions to Vantigā support various aspects of Seva
              ...
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                ...
                />
                <p className="text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
                  Overall, Vantigā plays a crucial role in maintaining the
            ...
            <div className="space-y-6 desktop-1200:space-y-6 desktop-1500:space-y-8 desktop-1900:space-y-10">
              ...
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                <img
                  src={grantsIcon}
                  alt="grantsIcon"
                  className="w-5 h-full text-[#E67E22] flex-shrink-0 mt-1 desktop-1200:w-5 desktop-1500:w-6 desktop-1900:w-7"
                />
                <p className="text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
          ...
          <div>
            ...
            <div className="space-y-6 desktop-1200:space-y-6 desktop-1500:space-y-8 desktop-1900:space-y-10">
              <div className="flex gap-3 desktop-1200:gap-4 desktop-1500:gap-5 desktop-1900:gap-6">
                <img
                  ...
                  className="w-5 h-5 text-[#E67E22] flex-shrink-0 mt-1 desktop-1200:w-5 desktop-1200:h-5 desktop-1500:w-6 desktop-1500:h-6 desktop-1900:w-7 desktop-1900:h-7"
                />
                <p className="text-sm sm:text-base text-gray-600 font-semibold desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl">
                  Who can pay Vantigā:
                </p>
              </div>
              <ul className="list-disc ml-10 text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl desktop-1200:ml-10 desktop-1500:ml-12 desktop-1900:ml-14">
                <li>Adult Bhānap</li>
                <li>
            ...
            <p className="mt-8 text-sm sm:text-base text-gray-600 desktop-1200:text-base desktop-1500:text-lg desktop-1900:text-xl desktop-1200:mt-8 desktop-1500:mt-10 desktop-1900:mt-12">
